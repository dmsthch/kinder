...
<div class="sidebar" data-color="blue">
	    	...
	    	<div class="sidebar-wrapper" style="overflow: visible;" id="exampleContent">
				<div class="wrapper">
				<ul class="nav" >
	                ...
	                <li id="kyo">
	                    <a id="sidekyo"  href="${pageContext.request.contextPath}/kyo">
	                        ...
	                        <p><div class="data-block f1">User Profile</div></p>
	                    </a>
	                </li>
                ...
                <!-- 페이지 가이드 -->
	                ...
	                <li id="kyotable">
	                    <a id="sidekyotable" href="${pageContext.request.contextPath}/kyotable">
	                        ...
	                        <p><div class="data-block f2">Table List</div></p>
	                    </a>
	                </li>
              ...
              <li class="tlypageguide_right" data-tourtarget=".f1">
                설명 첫번째
              </li>
              
              
              <li class="tlypageguide_right" data-tourtarget=".f2">
                설명 두번째
              </li>
